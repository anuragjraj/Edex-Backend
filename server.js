...
// ════════════════════════════════════════════════════════════════
const PLANS = {
  student_monthly:  { amount: 13000,  label: 'Student Monthly',  months: 1  },
  student_yearly:   { amount: 120000, label: 'Student Yearly',   months: 12 },
  teacher_monthly:  { amount: 15000,  label: 'Teacher Monthly',  months: 1  },
  teacher_yearly:   { amount: 150000, label: 'Teacher Yearly',   months: 12 },
};
